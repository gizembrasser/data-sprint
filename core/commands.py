...
def create_parser():
    ...
    parser_compare_tags.add_argument("file", nargs="?", help="Provide a file containing the data (CSV or Excel)")
    parser_compare_tags.add_argument("column", nargs="?", help="Specify the column name containing the URLs to the possible mirror sites")
    ...
    parser_scrape_css.add_argument("user_agent", nargs="?", help="Provide your user-agent.")
    ...
    parser_compare_css.add_argument("file", nargs="?", help="Provide a file containing the data (CSV or Excel)")
    parser_compare_css.add_argument("column", nargs="?", help="Specify the column name containing the URLs to the possible mirror sites")
